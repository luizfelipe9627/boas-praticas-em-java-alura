...
public class AbrigoService {
    ...
    public void listarAbrigo() throws IOException, InterruptedException {
        ...
        // Se a lista de abrigos estiver vazia.
        if (abrigoLista.isEmpty()) {
            System.out.println("Não há abrigos cadastrados!"); // Exibe a mensagem de que não há abrigos cadastrados.
        } else {
            mostrarAbrigosCadastrados(abrigoLista); // Chama o método mostrarAbrigosCadastrados passando a lista de abrigos.
        }


    }

    // Método responsável por exibir os abrigos cadastrados.
    private void mostrarAbrigosCadastrados(List<Abrigo> abrigoLista) {
