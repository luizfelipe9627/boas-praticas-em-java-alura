...
public class Abrigo {
    ...
    // Método setter para atribuir o id do abrigo.
    public void setId(Long id) {
        this.id = id; // Atribui o id do pet.
    }
    ...
    // A anotação @Override indica que o método toString foi sobrescrito.
    @Override
    // Método toString que retorna o id, nome, telefone e email do abrigo.
