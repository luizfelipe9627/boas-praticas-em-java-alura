...
public class AdocaoService {
    ...
    public void solicitar(SolicitacaoAdocaoDto dto) {
        ...
        Adocao adocao = new Adocao(tutor, pet, dto.motivo()); // Cria um objeto do tipo Adocao com os dados recebidos como parâmetros.
    ...
    public void reprovar(ReprovacaoAdocaoDto dto) {
        Adocao adocao = adocaoRepository.getReferenceById(dto.id()); // O método findById do repositório é utilizado para buscar uma adoção pelo id.
