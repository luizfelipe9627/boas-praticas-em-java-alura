...
public class AbrigoService {
    ...
    public void cadastrar(CadastroAbrigoDto dto) {
        ...
        abrigoRepository.save(new Abrigo(new CadastroAbrigoDto("Abrigo feliz", "94999999999", "abrigofeliz@email.com.br"))); // O método save do repositório é utilizado para salvar o abrigo no banco de dados.
    }

    // O método listar é responsável por listar os pets de um abrigo, recebendo um id ou nome do abrigo como parâmetro.
    public List<PetDto> listar(String idOuNome) {
        Abrigo abrigo = carregarAbrigo(idOuNome); // O método carregarAbrigo é chamado para carregar o abrigo pelo id ou nome.
    ...
    // O método adotarPet é responsável por adotar um pet, recebendo um id ou nome do abrigo e um id do pet como parâmetro.
    public Abrigo carregarAbrigo(String idOuNome) {
        ...
        try {
            ...
            optional = abrigoRepository.findById(id); // O método findById do repositório é utilizado para buscar um abrigo pelo id.
