...
public class AdocaoController {
    ...
    public ResponseEntity<String> solicitar(@RequestBody @Valid Adocao adocao) {
        ...
        try {
            this.adocaoService.solicitar(adocao); // O método solicitar do serviço é chamado, passando o objeto adocao como parâmetro.
    ...
    public ResponseEntity<String> aprovar(@RequestBody @Valid Adocao adocao) {
        // O bloco try-catch é utilizado para tratar exceções, sendo executado o bloco de código do try caso não ocorra exceção e o bloco de código do catch caso ocorra exceção.
        try {
            this.adocaoService.aprovar(adocao); // O método aprovar do serviço é chamado, passando o objeto adocao como parâmetro.
    ...
    public ResponseEntity<String> reprovar(@RequestBody @Valid Adocao adocao) {
        try {
            this.adocaoService.reprovar(adocao); // O método reprovar do serviço é chamado, passando o objeto adocao como parâmetro.
