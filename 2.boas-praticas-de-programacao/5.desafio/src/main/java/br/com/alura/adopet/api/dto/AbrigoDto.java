...
public record AbrigoDto(
        ...
        @NotNull
        Long id, // Criado um atributo idPet do tipo Long responsável por identificar o abrigo.
    ...
    public AbrigoDto(Abrigo abrigo) {
        this(abrigo.getId(), abrigo.getNome()); // O construtor recebe um objeto do tipo Abrigo e atribui os valores dos atributos idPet e nome do abrigo aos atributos idPet e nome do DTO.
    }
}
