...
public class TutorService {
    ...
    public void cadastrar(CadastroTutorDto dto) {
        ...
        if (jaCadastrado) {
            throw new ValidationException("Dados já cadastrados para outro tutor!"); // A resposta da requisição é uma mensagem de erro.
        }
    ...
    public void atualizar(AtualizacaoTutorDto dto) {
        Tutor tutor = tutorRepository.getReferenceById(dto.idTutor()); // O método getReferenceById do repositório é utilizado para buscar o tutor pelo idAbrigo.
