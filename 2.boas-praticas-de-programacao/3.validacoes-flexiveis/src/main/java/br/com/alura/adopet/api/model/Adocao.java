...
public class Adocao {
    ...
    // O método setData é responsável por atribuir uma data a adoção.
    public void setData(LocalDateTime data) {
        this.data = data; // Retorna a data da adoção.
    }
    ...
    // O método setTutor é responsável por atribuir um tutor a adoção.
    public void setTutor(Tutor tutor) {
        this.tutor = tutor; // Atribui um tutor a adoção.
    }
    ...
    // O método getStatus é responsável por atribuir um status a adoção.
    public void setStatus(StatusAdocao status) {
        this.status = status; // Atribui um status a adoção.
    }
    ...
    // O método setMotivo é responsável por atribuir um motivo a adoção.
    public void setMotivo(String motivo) {
        this.motivo = motivo; // Atribui um motivo a adoção.
    }
    ...
    // O método setJustificativaStatus é responsável por atribuir uma justificativa do status a adoção.
    public void setJustificativaStatus(String justificativaStatus) {
        this.justificativaStatus = justificativaStatus; // Atribui uma justificativa do status a adoção.
    }
