...
public record SolicitacaoAdocaoDto(
        ...
        @NotNull
        Long idPet, // Criado um long chamado idPet responsável por receber o id do pet.
        // A anotação @NotNull indica que o atributo tutor não pode ser nulo.
        @NotNull
        Long idTutor, // Criado um long chamado idTutor responsável por receber o id do tutor.
